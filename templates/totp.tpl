<form name="password" method="post" action="" class="form-horizontal">
    <div id="edit_form" class="card" style="visibility:{$show_form}">
        ...
        <div class="card-body enable-asterisk">
            ...
            <div class="mb-3 {if $pPassword_password_current_text}has-error{/if}">
            ...
            <div class="mb-3 {if $pTOTP_secret_text}has-error{/if}">
            ...
            <div class="mb-3 {if $pTOTP_code_text}has-error{/if}">
